...
class StyleTransfer(object):
    ...
    def __call__(
        self, content, style, area=512, init_random=False, init_img=None, iter=500
    ):
        ...
        artwork, optimizer, scaler = self._init_call(
    ...
    def _init_call(self, content, style, area, init_random, init_img):
        ...
        scaler = GradScaler(2.0**16, 2.0, 0.5, 50, self.use_amp)
